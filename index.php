...
<title> Email Extractor by AMADOU TRAORE</title>
<script language="javascript" type="text/javascript">
<!-- Begin

// Created by AMADOU TRAORE
...
function findEmail() {
	...
	if (address_type == "web") {
		rawemail = input.match(/(http:\/\/+[a-zA-Z0-9]+[a-zA-Z0-9-]+\.[a-zA-Z0-9._/-]+)/gi);
	} else {
...
<div align="center">
	<form name="extractor" action="#" method="get">
		<table class="maincolor" cellpadding="4" cellspacing="0" border="0" width="799">
			<tr class="titlebarcolor" valign="middle">
				...
				<td align="right" class="copyrightfont">
					<!-- Please do not remove or modify the copyright notice. This is all I ask for in return -->
					 <a href="" title="Email Extractor" target="_blank"></a></td>
			</tr>
			<tr>
				<td valign="top" align="center" width="50%">
					<strong>Put Your Mail List Here </strong><br />
			...
			<tr>
				...
				<td valign="top" align="right" nowrap="nowrap">
					<br />
					Number of emails extracted : <input name="count" size="5" readonly="readonly" /></td>
			</tr>
			<tr>
				<td valign="top" align="left" colspan="2">
					...
					<br />
					<div align="right">
						<a href="http://www.google.com" title="Email Extractor" target="_blank"><strong></strong></a>
					</div></td>
			</tr>
		</table>
	</form>
